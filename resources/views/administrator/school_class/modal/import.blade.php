  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('administrators.school-classes.import') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="alert alert-warning">
            ...
            <a href="{{ asset('import-kelas-template.xlsx') }}" class="alert-link"><i class="bi bi-download"></i>
              di
              sini</a>
          </div>
