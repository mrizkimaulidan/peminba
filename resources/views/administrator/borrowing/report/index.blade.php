      ...
      <div class="card-body">
        <form action="" method="GET">
          ...
          <div class="d-flex gap-1 pt-3 pb-3">
            ...
            <a href="{{ route('administrators.borrowings-report.index') }}" class="btn btn-warning">Reset
              filter</a>
          </div>
        </form>
        ...
        <div class="d-flex flex-row-reverse pb-3">
          <a href="{{ route('administrators.borrowings-report.export', [request('start_date'), request('end_date')]) }}"
