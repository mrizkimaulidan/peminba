            ...
            <div class="col-12">
              <div class="mb-3">
                ...
                <input type="text" class="form-control @error('name', 'update') is-invalid @enderror" name="name"
                  value="{{ auth('officer')->user()->name }}" placeholder="Masukkan nama..">
                @error('name', 'update')
            ...
            <div class="col-12">
              ...
              <div class="input-group mb-3">
                ...
                <input type="email" class="form-control @error('email', 'update') is-invalid @enderror" name="email"
                  value="{{ auth('officer')->user()->email }}" placeholder="Masukkan email..">
                @error('email', 'update')
                <div class="d-block invalid-feedback">
                  {{ $message }}
                </div>
            ...
            <div class="col-12">
              ...
              <div class="input-group mb-3">
                ...
                <input type="number" class="form-control @error('phone_number', 'update') is-invalid @enderror"
                  name="phone_number" value="{{ auth('officer')->user()->phone_number }}"
